      ...
      <section className="pt-32 pb-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-6 text-lg text-neutral-600 max-w-xl leading-relaxed">
            Strukturierte Einheiten für alle Levels – von der ersten Rolle bis
            zum fortgeschrittenen Freestyle.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-px bg-neutral-200 border border-neutral-200 rounded-xl overflow-hidden">
            {(techniques ?? []).map((t) => (
              <div
                key={t.id}
                className="bg-white p-6 hover:bg-neutral-900 group transition-colors duration-200"
              >
                <h3 className="font-bold text-neutral-900 group-hover:text-white mb-1 transition-colors">
                  {t.name}
                </h3>
                <p className="text-sm text-neutral-500 group-hover:text-white/60 transition-colors">
                  {t.desc}
                </p>
              </div>
            ))}
