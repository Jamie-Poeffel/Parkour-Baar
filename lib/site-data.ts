...
const DEFAULT: SiteData = {
    ...
    techniques: [
        { id: "1", name: "Precision Jump",  desc: "Präzise Sprünge auf definierte Ziele" },
        { id: "2", name: "Kong Vault",      desc: "Hindernisse mit beiden Händen überwinden" },
        { id: "3", name: "Speed Vault",     desc: "Schnelles Überspringen im Lauf" },
        { id: "4", name: "Tic Tac",         desc: "Wandabdruck zur Richtungsänderung" },
        { id: "5", name: "Cat Balance",     desc: "Gleichgewicht auf Mauerkanten halten" },
